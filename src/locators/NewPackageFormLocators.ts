export const newPackageFormLocators = {
  ...
  projectsContainer:'.ng-dropdown-panel.ng-select-bottom',
  workPackageModuleProjectOption:'Package Module Project',
  priorityInput: '#wp-new-inline-edit--field-priority',
  priorityContainer: '.ng-dropdown-panel.inline-edit--field.priority.ng-select-bottom',
  normalProrityOption: 'Normal',
  attachmentsSection: '.hide-when-print.op-file-section--drop-box',
